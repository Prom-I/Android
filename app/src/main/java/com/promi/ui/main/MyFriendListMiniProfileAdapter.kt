...
import com.promi.R
import com.promi.databinding.ItemAddFriendBinding
import com.promi.databinding.ItemMiniProfileBinding
import com.promi.recyclerview.friend.Friend
import com.promi.recyclerview.notification.Notification


// 메인 화면에서 내 친구 목록을 띄우는 어뎁터
class MyFriendListMiniProfileAdapter()
    : ListAdapter<Friend, MyFriendListMiniProfileAdapter.MyFriendListItemViewHolder>(MyFriendListMiniProfileDiffUtil){
