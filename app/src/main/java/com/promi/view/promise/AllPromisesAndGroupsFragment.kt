...
import com.promi.view.group.GroupFragment
...
class AllPromisesAndGroupsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        childFragmentManager.beginTransaction().apply {
            add(R.id.frameLayout_all_promises_and_groups, GroupFragment())
            commit()
        }
        ...
        binding.btnShowGroup.setOnClickListener {
            childFragmentManager.beginTransaction().apply {
                replace(R.id.frameLayout_all_promises_and_groups, PromiseFragment())
        ...
        binding.btnShowPromise.setOnClickListener {
            childFragmentManager.beginTransaction().apply {
                replace(R.id.frameLayout_all_promises_and_groups, GroupFragment())
                addToBackStack(null) // 스택에 추가 (뒤로가기 구현을 위해서)
                commit()
            }
        }
