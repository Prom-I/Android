...
class PromiseTimeRecyclerViewAdapter(private val timeSize: Int, private val daySize: Int, private val itemWidth : Int)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val view = LayoutInflater.from(context).inflate(R.layout.item_promise_time_all_day, parent, false)
        // width 지정
//        view.findViewById<View>(R.id.view_time1).updateLayoutParams<ConstraintLayout.LayoutParams> {
//            width = itemWidth
//        }
